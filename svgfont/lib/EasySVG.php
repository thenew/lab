...
class EasySVG {
    ...
    public function addPath($def, $attributes=array()) {
        ...
        $animate = $path->addChild('animate attributeName="stroke-dashoffset" attributeType="XML" values="988.01; 0" begin="0s" dur="10s" repeatCount="indefinite" keySplines="0.99 0.19 0.5 1" calcMode="spline"');
